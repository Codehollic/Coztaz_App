...
class AttendanceOverallResultScreen extends GetWidget<AttendanceOverallResultController> {
  final List<bool> boolList = Get.arguments;

  @override
  Widget build(BuildContext context) {

    int presentCount = boolList.where((element) => element).length;
    int absentCount = boolList.where((element) => !element).length;
